...
from utils.conf import bot_start_daemong_cmd, STARTING_SYMBOL, SLEEP_SECONDS,UPDATE_MSG,WIKI_URL, MAXIMUM_ITERATIONS
...
def startHandler(update: Update, context: CallbackContext) -> None:
    ...
    updaterService.sendMessage(update, WELCOME_MSG, bot_start_daemong_cmd)
...
def start_daemonHandler(update: Update, context: CallbackContext) -> None:
    isRunning = context.user_data.get('isRunning', False)
