...
from utils.conf import bot_start_deamong_cmd, STARTING_SYMBOL, SLEEP_SECONDS,UPDATE_MSG,WIKI_URL, MAXIMUM_ITERATIONS
...
def startHandler(update: Update, context: CallbackContext) -> None:
    ...
    updaterService.sendMessage(update, WELCOME_MSG, bot_start_deamong_cmd)
